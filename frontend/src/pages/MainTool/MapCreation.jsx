...
return (
    <>
      {/* Container de Conteúdo: Onde o zoom é aplicado */}
      <div 
        className="map-creation-container" 
        style={{ 
          backgroundImage: `url(${fundomapas})`, 
      ...
      {/* Popups e Modais: Fora da div de zoom para garantir centralização e blur total */}
